...
public class SpawnGeneratorTests
{
    ...
    public void AClassWithItsSceneGetsSpawnFromANodeAndAtATransform()
    {
        var (diagnostics, generated) = Run(
            "namespace Game; [Netfox.Scene] public partial class Thing : Godot.RigidBody3D { }",
    ...
    {
        var (_, required) = Run(
            "namespace Game; public partial class Thing : Godot.Node3D, Netfox.ISpawnedWith<float> { public void OnSpawned(float fuse) { } }",
            ("game/Thing.tscn", RootScene("res://game/Thing.cs")));
        Assert.Contains("Spawn(global::Godot.Transform3D at, float args, global::Godot.Node? parent", required);

        var (_, optional) = Run(
            "namespace Game; public partial class Thing : Godot.Node3D, Netfox.ISpawnedWith<Godot.Color> { public void OnSpawned(Godot.Color color = default) { } }",
            ("game/Thing.tscn", RootScene("res://game/Thing.cs")));
    ...
    public void AClassWithoutASceneIsAnError()
        => Assert.Contains(Run(
                "namespace Game; [Netfox.Scene] public partial class Thing : Godot.Node3D { }",
                ("game/Other.tscn", RootScene("res://game/Other.cs"))).Diagnostics,
            diagnostic => diagnostic.Id == "NFX003");
    ...
    public void AClassAtTheRootOfTwoScenesIsAnError()
        => Assert.Contains(Run(
            ...
            diagnostic => diagnostic.Id == "NFX004");

    [Fact]
    public void SpawnDataThatDoesNotFitAVariantIsAnError()
        => Assert.Contains(Run(
                "namespace Game; public record struct Charge(float Value); public partial class Thing : Godot.Node3D, Netfox.ISpawnedWith<Charge> { public void OnSpawned(Charge charge) { } }",
                ("game/Thing.tscn", RootScene("res://game/Thing.cs"))).Diagnostics,
            diagnostic => diagnostic.Id == "NFX005");
    ...
    public void APartialClassSpanningFilesFindsTheSceneNextToTheFileNamedAfterIt()
    {
        var (diagnostics, generated) = Run(
            [
                ...
                ("namespace Game; [Netfox.Scene] public partial class Thing : Godot.Node3D { }", "game/Thing.cs"),
            ],
            ("game/Thing.tscn", RootScene("res://game/Thing.cs")));
