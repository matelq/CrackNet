...
/// <summary>
/// One CrackNet stack in a test: its own <see cref="CrackNetContext"/> (so its own servers), its own MultiplayerAPI rooted
...
/// </summary>
public partial class CrackNetStack : CrackNetContextRoot
{
    ...
    public static CrackNetStack Create(Node parent, string name, LoopbackNetwork network, int peerId)
    {
        var stack = new CrackNetStack { Name = name };
