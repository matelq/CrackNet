...
/// tests, generated levels — suppresses the rule with <c>#pragma warning disable NFX006</c>.
/// </para>
/// </summary>
[DiagnosticAnalyzer(LanguageNames.CSharp)]
public sealed class NetworkedNodeAnalyzer : DiagnosticAnalyzer
{
    private const string Extensions = "Netfox.NetworkNodeExtensions";

    private static readonly DiagnosticDescriptor NoNetworkObject = new(
        "NFX006", "A node used over the network needs a NetworkObject in its scene",
