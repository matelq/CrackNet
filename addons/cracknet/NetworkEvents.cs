...
public partial class NetworkEvents : Node
{
    ...
    /// <summary>Events are only emitted while enabled. Initial value comes from cracknet/events/enabled.</summary>
    public bool Enabled
    {
        get => _enabled;
    ...
    {
        CrackNetLogger.RegisterTag(_peerIdTag, -99);

        Enabled = CrackNetSettings.Instance.EventsEnabled;
    ...
    {
        CrackNetLogger.FreeTag(_peerIdTag);
